  ...
  return (
    <div className="max-w-3xl mx-auto py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground">Everything you need to know about using Meeting Branch.</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-card border shadow-sm rounded-3xl p-8">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Meeting Branch calculates the total cost for your household based on the per-person fee set by your organizer.
            Once you register, you'll see the payment instructions (usually a Cash App, Venmo, or PayPal link).
            Send your payment outside of Meeting Branch, and the organizer will manually mark your registration as "Paid" once they receive it.
          </p>
        </div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            {settings === undefined ? null : canCreateReunion ? (
              ...
              <>
                ...
                reunion on Meeting Branch, reach out to your platform administrator to get set up.
              </>
            )}
          </p>
        </div>
